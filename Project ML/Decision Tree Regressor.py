...
ypred_scale=grid_cart.predict(test_selected)
ypred_scale=pd.DataFrame(ypred_scale)
ypred=target_scaler.inverse_transform(ypred_scale)
ypred

pred_data=pd.DataFrame(ypred,columns=['Price_pred'])
...
target_pred.to_csv("C:/Users/Minh MPC/Downloads/DecisionTreeRegressor.csv", index=False)
