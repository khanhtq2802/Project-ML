...
data.drop(['room','area','toilet','id'], inplace=True, axis=1)
data[data.columns[data.isna().sum() > 0]].isna().mean
...
y_train=y[mask]
print(y_train)
print("a"+f"{x_train.shape, y_train.shape}")
...
final_gradient.fit(x_selected, y_scaled.ravel())
...
test_en_2=result_test[2204:3350]
test_en_2.shape
...
target_pred.to_csv("C:/Users/Minh MPC/Downloads/RandomForest.csv", index=False)
